# Rusty (Extension Dev) — Archived Learning History

Historical entries from early project development (2026-02-13 through 2026-02-17). These learnings remain foundational; recent entries are in `history.md`.

## Archived Entries (2026-02-13 through 2026-02-17)
...
- **Recent Sessions in Activity tab:** Panel below swimlanes, last 10 log entries as clickable cards; DashboardData.activity extended with ecentLogs field
